...
from app.core.validation import optional_uploaded_stats, uploaded_file
...
def upload_game_media(tag):
    file = uploaded_file()
    video_stats = optional_uploaded_stats()
    return jsonify(upload_game_video(tag, file, video_stats=video_stats)), 202
