...
@game_media_bp.get("/games/<tag>/entities/<entity_id>/image")
def show_entity_image(tag, entity_id):
    content, mime_type = entity_image_bytes(tag, entity_id)
    return send_image_bytes(content, mime_type)
