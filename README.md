...
`twelvelabs-ui` with React, TypeScript, Vite, Tailwind CSS, HLS.js
...
1. **Create `twelvelabs-ui/.envlocal`**
...
The `twelvelabs-ui` app runs at `http://localhost:5173`.
...
twelvelabs-ui/
  src/app/               Sports Jockey app migrated onto TwelveLabs UI components and tokens
  src/components/ui/     TwelveLabs UI primitive components
  src/icons/             TwelveLabs UI icon components
```
